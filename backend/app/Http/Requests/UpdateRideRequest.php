...
class UpdateRideRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'origin_city' => ['sometimes', 'required', 'string', 'max:120'],
            ...
            'destination_city' => ['sometimes', 'required', 'string', 'max:120'],
            ...
            'seats_total' => ['sometimes', 'required', 'integer', 'between:1,8'],
            'luggage_size' => ['sometimes', 'required', 'in:small,medium,large'],
    ...
    public function messages(): array
    {
        return [
            ...
            'status.in' => 'Неверный статус. Доступные значения: draft, published, in_progress, completed, cancelled.',
        ];
    }
}

...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'Указанное :attribute появилось в утечке данных. Выберите другое :attribute.',
    ],
    ...
    'attributes' => [
        ...
        'color' => 'Цвет',
        'plate_number' => 'Номер',
        'comfort_class' => 'Класс комфорта',
        'ownership_document' => 'Документ о владении ТС',
        'license_document' => 'Водительские права',
        'amount' => 'Сумма',
        'receipt' => 'Чек',
        'origin_city' => 'Город отправления',
        'origin_address' => 'Адрес отправления',
        'destination_city' => 'Город прибытия',
        'destination_address' => 'Адрес прибытия',
        'departure_time' => 'Время отправления',
        'arrival_time' => 'Время прибытия',
        'price' => 'Цена',
        'seats_total' => 'Количество мест',
        'seats_requested' => 'Количество мест',
        'luggage_size' => 'Размер багажа',
        'pets_allowed' => 'Разрешены животные',
        'smoking_allowed' => 'Разрешено курение',
        'notes' => 'Примечания',
        'target_id' => 'Получатель отзыва',
        'rating' => 'Оценка',
        'comment' => 'Комментарий',
